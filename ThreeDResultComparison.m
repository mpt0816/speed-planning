function ThreeDResultComparison(planning_data_pid, planning_data_qp, planning_data_lattice)
...
%% Lattice
%% simulation timestamp
timestamp_lattice = planning_data_lattice(:,1);
%% station of ego car
station_ego_lattice = planning_data_lattice(:,2);
%% velocity of ego car
velocity_ego_lattice = planning_data_lattice(:,3);
%% acceleration of ego car
acceleration_ego_lattice = planning_data_lattice(:,4);
%% jerk of ego car
jerk_ego_lattice = planning_data_lattice(:,5);
%% station of ahead obstacle car
station_obstacle_lattice = planning_data_lattice(:,6);
%% velocity of ahead obstacle car
velocity_obstacle_lattice = planning_data_lattice(:,7);
%% acceleration of ahead obstacle car
acceleration_obstacle_lattice = planning_data_lattice(:,8);
...
hold on
plot(timestamp_lattice, station_ego_lattice, '-m', 'LineWidth', 0.5);

title('station');
xlabel('time(s)');
ylabel('station(m)');
legend('ahead car', 'pid', 'qp', 'lattice');
...
hold on;
plot(timestamp_lattice, velocity_ego_lattice, '-m', 'LineWidth', 0.5);
...
hold on;
plot(timestamp_lattice, acceleration_ego_lattice, '-m', 'LineWidth', 0.5);
...
hold on;
plot(timestamp_lattice, jerk_ego_lattice, '-m', 'LineWidth', 0.5);

title('jerk');
xlabel('time(s)');
ylabel('jerk(m/s3)');
legend('pid', 'qp', 'lattice');
...
actual_follow_distance_lattice = planning_data_lattice(:,6) - planning_data_lattice(:,2); 
command_follow_distance_lattice = track_reserved_time * planning_data_lattice(:,3) + track_reserved_distance;
...
hold on;
plot(timestamp_lattice, actual_follow_distance_lattice, '-m', 'LineWidth', 0.5);
hold on;
plot(timestamp_lattice, command_follow_distance_lattice, '--m', 'LineWidth', 0.5);

title('Follow Distance');
xlabel('time(s)');
ylabel('station(m)');
legend('actual follow distance pid', 'required follow distance pid', 'actual follow distance qp', 'required follow distance qp', 'actual follow distance lattice', 'required follow distance lattice');
grid on;
